...
public class MyApplication extends Application {
    ...
    public void initData() {
        ...
        News news3 = new News("7号文件解密", "没有内容", "锦城青年", R.drawable.ic_image_default, dateNow, null, null, 2L, 127);
        News news4 = new News("和西瓜最配的动画电影\n一定要看哟", "没有内容", "四川大学锦城学院", R.mipmap.news_cartoon_movie, dateNow, null, null, 0L, 36);
            ...
            for (int i = 0; i < 4; i++) {
                ...
                News news = new News("再不睡就死了!熬最长的夜,住最贵的ICU" + i + "来自类型" + c,
                        "随便生成的初始化新闻\n类型" + c + "的第" + i + "条新闻\n\n" +
                                ...
                                "但请记得：\n" +
                                "健康是根本，\n" +
                                "且作且珍惜！", "郑维" + i + "类型" +c , R.mipmap.news_time_go_to_sleep, date, null,
                        "睡觉", c, 0);
                newsList.add(news);
            }
        }
