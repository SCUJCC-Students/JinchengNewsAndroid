...
public class MyApplication extends Application {
    ...
    public void initData() {
        ...
        News news1 = new News("再不睡觉就要死了！熬最长的夜，住最贵的ICU", "说真的，好久没有好好睡个觉了。现在熬夜和面膜都不配了，最配的都变成ICU了。锦城猪健文日了解一下？", "郑维一", dateNow, null, null, 0L, 526);
        News news2 = new News("2018年四川省高校国旗护卫队联盟会操暨锦城国旗护卫队十周年庆典在我校举行", "锦城国旗护卫队讯 2018年5月26日，2018年四川省高校国旗护卫队联盟会操暨锦城国旗护卫队十周年庆典在我校第一运动场举行，来自四川省27所高校国旗护卫队、国旗班、仪仗队的战友们齐聚锦城。", "锦城国旗护卫队", dateNow, null, null, 2L, 2387);
        News news3 = new News("毕业季，3招教你拍出网红毕业照", "没有内容", "锦城青年", dateNow, null, null, 1L, 127);
        News news4 = new News("和西瓜最配的动画电影", "没有内容", "四川大学锦城学院", dateNow, null, null, 0L, 36);
        News news5 = new News("我校第十二届大学生创新创业大赛总决赛暨颁奖典礼精彩预告", "没有内容", "四川大学锦城学院", dateNow, null, null, 0L, 90);
        News news6 = new News("小便带你回顾去年做客锦大的那些明星", "没有内容", "四川大学锦城学院", dateNow, null, null, 0L, 1370);
        News news7 = new News("民谣伴你度周末！", "没有内容", "四川大学锦城学院", dateNow, null, null, 0L, 130);
        News news8 = new News("思考未来 方可赢得未来 —— 《未来型教育论坛学术论文集》", "没有内容", "四川大学锦城学院", dateNow, null, null, 0L, 38);
        newsList.add(news1);
        newsList.add(news2);
        newsList.add(news3);
        newsList.add(news4);
            ...
            for (int i = 0; i < 15; i++) {
                ...
                News news = new News("再不睡就死了!熬最长的夜,住最贵的ICU" + i + "来自类型" + c,
                        "说真的，好久没有好好睡个觉了。现在熬夜和面膜都不配了，最配的都变成ICU了。" +
                                "锦城猪健文日了解一下？" + i, "郑维" + i + "类型" +c , date, null,
                        "睡觉", c, 0);
                newsList.add(news);
            }
        }
